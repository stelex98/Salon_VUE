        ...
        <v-container ma-0 pa-0 fluid>
            <v-layout style = "height: 100%">
                ...
                >
                    ...
                    <formAddNewService v-if = 'checkIsAddNewService'></formAddNewService>
                </v-flex>
            </v-layout>
        </v-container>
    </v-app>
...
export default {
    ...
    computed: {
        ...
        checkIsAddNewService(){
            this.isAddNewService = (this.currentAction  === 'Услуги' ? true: false);

            return this.isAddNewService;
        }
    },
  data() {
    return {
        ...
        isAddNewService : this.currentAction
    }
  }
};
</script>
